...
public class Game {
    ...
    public void undo(){
        ...
        if(lastMove == null)
            return;
        upddateTheCellAndUndoStrategies(lastMove);

        updateNextPlayer();
    }

    private void upddateTheCellAndUndoStrategies(Move lastMove){
    ...
    public static class Builder{
        ...
        private void validateDimentionsAndPlayerCount() throws PlayersCountMismatchException{
